...
*/
$page = $a[0]; // We want to preserve extra arguments in the jump list URL past the vineyard and block if we have not changed pages.
               // we will store this and compare 
if (!isset($a[1])) {
