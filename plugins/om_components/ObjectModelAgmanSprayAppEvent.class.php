...
class ObjectModelAgmanSprayAppEvent extends ObjectModelComponentsDefaultHandler {
  ...
  public function buildForm(&$form, $form_state) {
    ...
    */
    ...
    $form['chem_rates']['#prefix'] .= '<li>' . t('<b>Material Label Range & Canopy Scale Rates</b> This field will give recomnmendations for <b>Chosen Rates</b> based on that value in <b>Select a percentage of canopy to be covered</b>.') . '</li>';
